...
var defaultEndpointInfoMap = map[constant.EndpointType]EndpointInfo{
	...
	constant.EndpointTypeSentenceSimilarity:    {Path: "/v1/sentence-similarity", Method: "POST"},
	constant.EndpointTypeRerankMultimodal:      {Path: "/v1/rerank/multimodal", Method: "POST"},
}
