...
export function SidebarModulesSection({
  ...
  const sectionMeta: Record<string, { title: string; description: string }> = {
    ...
    personal: {
      ...
      description: t('Redemption code balance and personal preferences.'),
    },
    admin: {
      title: t('Admin area'),
  ...
  > = {
    ...
    personal: {
      topup: {
        ...
        description: t('Redeem codes to add account balance.'),
      },
      personal: {
        title: t('Profile'),
    ...
    admin: {
      ...
      subscription: {
        ...
        description: t('Paid subscription plans and pricing.'),
      },
    },
  }
