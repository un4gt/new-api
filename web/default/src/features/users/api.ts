...
import type {
  ...
  ApiResponse,
  GetRegistrationInvitesParams,
  GetRegistrationInvitesResponse,
  CreateRegistrationInvitePayload,
...
// ============================================================================
// Registration Invite Management APIs
// ============================================================================

export async function getRegistrationInvites(
  params: GetRegistrationInvitesParams = {}
): Promise<GetRegistrationInvitesResponse> {
  ...
  const res = await api.get(`/api/registration-invite/?${queryParams}`)
  return res.data
}

export async function createRegistrationInvite(
  payload: CreateRegistrationInvitePayload
): Promise<CreateRegistrationInviteResponse> {
...
export async function revokeRegistrationInvite(
  ...
  const res = await api.post(`/api/registration-invite/${id}/revoke`)
  return res.data
}
