...
export const channelFormSchema = z
  .object({
    ...
    custom_balance_script: z.string().optional(),
...
export function transformChannelToFormDefaults(
  ...
  if (channel.settings) {
    try {
      ...
      customBalanceScript = parsed.custom_balance_script || ''
  ...
  return {
    ...
    custom_balance_script: customBalanceScript,
...
function buildSettingsJSON(formData: ChannelFormValues): string {
  ...
  if (formData.custom_balance_script?.trim()) {
    settingsObj.custom_balance_script = formData.custom_balance_script.trim()
  } else if ('custom_balance_script' in settingsObj) {
    delete settingsObj.custom_balance_script
  }
